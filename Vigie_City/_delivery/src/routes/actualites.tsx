...
// Type étendu pour inclure image_url (ajouté par migration Session 4)
type Publication = {
  id: string;
  title: string;
  content: string;
    ...
    <div className="space-y-4 px-4 pt-5">
      <header>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          {communeName
            ? `Publications officielles — ${communeName}`
            : "Publications de votre commune."}
        </p>
      </header>
        ...
        <ul className="space-y-3">
          {data?.map((pub) => {
            ...
            return (
              ...
              >
                {/* Image 16:9 — affichée si présente */}
                {pub.image_url && (
                  <img
                    src={pub.image_url}
                    alt={pub.title}
                ...
                <div className="flex items-start gap-3 p-4">
                  {/* Icône catégorie — masquée si image présente pour alléger le visuel */}
                  {!pub.image_url && (
                    <div
