...
export const Route = createFileRoute("/")({
  head: () => ({
    ...
    meta: [
      ...
      { property: "og:url", content: "https://vigiecity.fr" },
      { property: "og:image", content: "https://vigiecity.fr/og-image.png" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "VigieCity — L'application citoyenne pour votre commune" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "VigieCity — L'app citoyenne pour votre commune" },
      {
        name: "twitter:description",
        content:
          "Alertes, signalements, agenda, infos locales — tout ce dont vos habitants ont besoin pour rester connectés à leur territoire.",
      },
      { name: "twitter:image", content: "https://vigiecity.fr/og-image.png" },
    ],
  }),
